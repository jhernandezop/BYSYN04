...
fetch(url, {
  ...
  estadoLogin=(data)=> {
    ...
    this.setState({cargo:data.cargo});
    console.log(data)
    ...
    if(this.state.estadoLogin==false){
      ...
      return (
        <div className="container-fluid h-100">
          ...
          <div id="contenedor_app" className="row h-100 ">
                ...
                <ReporteUsuario anexo={this.state.anexo} gruposCandidatos={this.state.gruposCandidatos}/>
      ...
      return (
        <div className="container-fluid h-100">
          ...
          <div id="contenedor_app" className="row h-100 ">
                <ReporteSupervisor anexo={this.state.anexo} cargo={this.state.cargo}/>
          </div>
        </div>
      );
...
/*
  ...
  render() {
    ...
    const listItems = opciones.map((number) => (number.ver==true) ?
      ...
      <button title={number.toltip} key={number.opcion} type="button"  onClick={() => this.props.navegarInterfaz(number.funcion)} className="btn btn-light">
